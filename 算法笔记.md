...
<img src="算法笔记.assets/1604652948-aynZEu-file_1604652948347.jpeg" alt="img" style="zoom:33%;" />
...
![image-20241014203823134](算法笔记.assets/image-20241014203823134.png)
...
![image-20241015124345341](算法笔记.assets/image-20241015124345341.png)

## [160. 相交链表](https://leetcode.cn/problems/intersection-of-two-linked-lists/)

![image-20241014230039081](算法笔记.assets/image-20241014230039081.png)
...
<img src="算法笔记.assets/image-20241014230112374.png" alt="image-20241014230112374" style="zoom:80%;" />
...
![image-20241014231435402](算法笔记.assets/image-20241014231435402.png)
...
![image-20241014231520242](算法笔记.assets/image-20241014231520242.png)
...
![image-20241014231946798](算法笔记.assets/image-20241014231946798.png)
...
![image-20241014232314715](算法笔记.assets/image-20241014232314715.png)
...
![image-20241015151341601](算法笔记.assets/image-20241015151341601.png)
...
![image-20241015153012095](算法笔记.assets/image-20241015153012095.png)
...
![image-20241015163936396](算法笔记.assets/image-20241015163936396.png)
...
![image-20241015164228997](算法笔记.assets/image-20241015164228997.png)
...
![image-20241015164336766](算法笔记.assets/image-20241015164336766.png)
...
![image-20241015170207224](算法笔记.assets/image-20241015170207224.png)
...
![image-20241015170517511](算法笔记.assets/image-20241015170517511.png)
...
![image-20241015222235072](算法笔记.assets/image-20241015222235072.png)
...
![image-20241015223033021](算法笔记.assets/image-20241015223033021.png)
...
![image-20241015223549392](算法笔记.assets/image-20241015223549392.png)
...
![image-20241015224315013](算法笔记.assets/image-20241015224315013.png)
...
![image-20241015231905681](算法笔记.assets/image-20241015231905681.png)
...
![image-20241016143303044](算法笔记.assets/image-20241016143303044.png)
...
![image-20241016144231272](算法笔记.assets/image-20241016144231272.png)
...
![image-20241016144246970](算法笔记.assets/image-20241016144246970.png)
...
class Solution {
    public boolean wordBreak(String s, List<String> wordDict) {
        ...
        dp[0] = true;//易错点，一定要记得设置啊！！！
        //完全背包，先遍历背包，后遍历物品！！！
        for(int j = 0; j <= n; j++){
            for(String str : wordDict){
                if(j+str.length() > s.length())
                    continue;
                String cur = s.substring(j,j+str.length());
                if(dp[j] == true && str.equals(cur))
                    dp[j+str.length()] = true;
            }
        }
...
![image-20241016145551989](算法笔记.assets/image-20241016145551989.png)
...
![image-20241016145932873](算法笔记.assets/image-20241016145932873.png)
...
![image-20241016150139797](算法笔记.assets/image-20241016150139797.png)
...
![image-20241016161021502](算法笔记.assets/image-20241016161021502.png)
...
![image-20241016162225501](算法笔记.assets/image-20241016162225501.png)
...
class Solution {
    public int findTargetSumWays(int[] nums, int target) {
        ...
        dp[0] = 1;
        for(int i = 0; i < nums.length; i++){
            for(int j = n; j >= nums[i]; j--){//01背包，到这遍历
                dp[j] += dp[j-nums[i]];
            }
        }
...
![image-20241016163629732](算法笔记.assets/image-20241016163629732.png)
...
![image-20241016164820169](算法笔记.assets/image-20241016164820169.png)
...
![image-20241016165850609](算法笔记.assets/image-20241016165850609.png)
...
![image-20241016172106345](算法笔记.assets/image-20241016172106345.png)
...
![image-20241016174527425](算法笔记.assets/image-20241016174527425.png)
...
![image-20241016175213654](算法笔记.assets/image-20241016175213654.png)
...
![image-20241016175759094](算法笔记.assets/image-20241016175759094.png)
...
![image-20241017140649950](算法笔记.assets/image-20241017140649950.png)
...
![image-20241017142453157](算法笔记.assets/image-20241017142453157.png)
...
![image-20241017145722095](算法笔记.assets/image-20241017145722095.png)
...
![image-20241017150946784](算法笔记.assets/image-20241017150946784.png)
...
![image-20241017152029659](算法笔记.assets/image-20241017152029659.png)
...
class Solution {
    public int maxProfit(int[] prices) {
        ...
        int[][] dp = new int[prices.length][2];//0代表持有 1代表不持有
        dp[0][0] = -prices[0];
...
![image-20241017153032589](算法笔记.assets/image-20241017153032589.png)
...
![image-20241017153106350](算法笔记.assets/image-20241017153106350.png)

```java
class Solution {
    public int lengthOfLIS(int[] nums) {
        int[] tails = new int[nums.length];
        int res = 0;//// res为 tails 当前长度,代表直到当前的最长上升子序列长度。
...
![image-20241017210241664](算法笔记.assets/image-20241017210241664.png)
...
![image-20241011211346574](算法笔记.assets/image-20241011211346574.png)

## [283. 移动零](https://leetcode.cn/problems/move-zeroes/)

![image-20241017211238448](算法笔记.assets/image-20241017211238448.png)
...
![image-20241017211540735](算法笔记.assets/image-20241017211540735.png)
...
![image-20241017212233965](算法笔记.assets/image-20241017212233965.png)
...
![image-20241017212723180](算法笔记.assets/image-20241017212723180.png)
...
![image-20241017213601669](算法笔记.assets/image-20241017213601669.png)
...
![image-20241017215856053](算法笔记.assets/image-20241017215856053.png)
...
![image-20241017222251359](算法笔记.assets/image-20241017222251359.png)

![img](算法笔记.assets/1638557961-CREXjV-ccw-01-07.008.png)

## [46. 全排列](https://leetcode.cn/problems/permutations/)

![image-20241017222335363](算法笔记.assets/image-20241017222335363.png)
...
![image-20241017224114906](算法笔记.assets/image-20241017224114906.png)
...
![image-20241017224819870](算法笔记.assets/image-20241017224819870.png)
...
就是求树的高度，然后每个节点都更新一次max

## [34. 在排序数组中查找元素的第一个和最后一个位置](https://leetcode.cn/problems/find-first-and-last-position-of-element-in-sorted-array/)

![image-20241017230437400](算法笔记.assets/image-20241017230437400.png)
...
![image-20241017231833037](算法笔记.assets/image-20241017231833037.png)
...
![image-20241018091918497](算法笔记.assets/image-20241018091918497.png)
...
![image-20241018093817415](算法笔记.assets/image-20241018093817415.png)

## [538. 把二叉搜索树转换为累加树](https://leetcode.cn/problems/convert-bst-to-greater-tree/)

![image-20241018095155832](算法笔记.assets/image-20241018095155832.png)
...
![image-20241018095840427](算法笔记.assets/image-20241018095840427.png)
...
链接：https://leetcode.cn/problems/subarray-sum-equals-k/solutions/2794955/qing-xi-de-tu-shi-tui-dao-by-shawxing-kw-crp3/

## [21. 合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)

![image-20241018101939730](算法笔记.assets/image-20241018101939730.png)
...
![image-20241018102150232](算法笔记.assets/image-20241018102150232.png)
...
![image-20241018104012041](算法笔记.assets/image-20241018104012041.png)

```java
class Solution {
    public ListNode removeNthFromEnd(ListNode head, int n) {
        ListNode dummy = new ListNode();//这题要用虚拟头结点的，实现起来方便一些
        dummy.next = head;
...
![image-20241018164457420](算法笔记.assets/image-20241018164457420.png)
...
注意这道题for循环遍历的是字母，但是传index的时候并不是i+1，而是index+1

## [15. 三数之和](https://leetcode.cn/problems/3sum/)

![image-20241018164556361](算法笔记.assets/image-20241018164556361.png)
...
class Solution {
    public List<List<Integer>> threeSum(int[] nums) {
        ...
        for(int i = 0; i < nums.length - 2; i++){
            if(nums[i] > 0) break;//两个break
            if(nums[i] + nums[i+1] + nums[i+2] > 0) break;//两个break
            if(i!=0 && nums[i] == nums[i-1]) continue;//一个continue
            ...
            while(left < right){
                ...
                if(sum < 0)
                    ...
                    List<Integer> path = new ArrayList<>(Arrays.asList(nums[i],nums[left],nums[right]));//老是忘了！！！
                    list.add(path);
                    while(left < right && nums[left] == nums[left+1]) left++;
                    while(left < right && nums[right] == nums[right-1]) right--;
                    left++;//别忘了加！！！
...
![image-20241018165721192](算法笔记.assets/image-20241018165721192.png)
...
![image-20241018170310846](算法笔记.assets/image-20241018170310846.png)
...
![image-20241018171039058](算法笔记.assets/image-20241018171039058.png)
...
![image-20241018224228826](算法笔记.assets/image-20241018224228826.png)
...
![image-20241018225622955](算法笔记.assets/image-20241018225622955.png)
...
![image-20241019111518768](算法笔记.assets/image-20241019111518768.png)
...
![image-20241019112054944](算法笔记.assets/image-20241019112054944.png)
...
<img src="算法笔记.assets/1666689295-VuBpQL-image.png" alt="image.png" style="zoom:67%;" />

## [617. 合并二叉树](https://leetcode.cn/problems/merge-two-binary-trees/)

![image-20241019141306747](算法笔记.assets/image-20241019141306747.png)
...
![image-20241019142211628](算法笔记.assets/image-20241019142211628.png)
...
![image-20241019143510839](算法笔记.assets/image-20241019143510839.png)
...
![image-20241019143634288](算法笔记.assets/image-20241019143634288.png)
...
![image-20241019144105791](算法笔记.assets/image-20241019144105791.png)
...
class Solution {
    ...
    public boolean search(TreeNode left,TreeNode right){
        ...
        boolean a = search(left.left,right.right);
        boolean b = search(left.right,right.left);
...
![image-20241019144530949](算法笔记.assets/image-20241019144530949.png)
...
![image-20241019145418796](算法笔记.assets/image-20241019145418796.png)
...
![image-20241019145740085](算法笔记.assets/image-20241019145740085.png)
...
中序遍历不需要先将root入栈，是在循环里逐个入栈，整个过程是先向最左下角找，找不到出栈然后指向右子树。

## [1. 两数之和](https://leetcode.cn/problems/two-sum/)

![image-20241019150904253](算法笔记.assets/image-20241019150904253.png)
...
![image-20241019151654553](算法笔记.assets/image-20241019151654553.png)
...
![image-20241019153103267](算法笔记.assets/image-20241019153103267.png)
...
![image-20241019153444408](算法笔记.assets/image-20241019153444408.png)

```java
class Solution {
    public int minDistance(String word1, String word2) {
        int[][] dp = new int[word1.length()+1][word2.length()+1];
        for(int i = 0; i <= word1.length(); i++)//注意有等于号
            dp[i][0] = i;
        for(int j = 0; j <= word2.length(); j++)//注意有等于号
            dp[0][j] = j;
...
![image-20241019154053106](算法笔记.assets/image-20241019154053106.png)
...
![image-20241019154357544](算法笔记.assets/image-20241019154357544.png)
...
![image-20241014201824496](算法笔记.assets/image-20241014201824496.png)
...
![image-20241019161806405](算法笔记.assets/image-20241019161806405.png)
...
![image-20241019162023218](算法笔记.assets/image-20241019162023218.png)
...
![image-20241019162555829](算法笔记.assets/image-20241019162555829.png)
...
![image-20241019162754255](算法笔记.assets/image-20241019162754255.png)
...
![image-20241011202409670](算法笔记.assets/image-20241011202409670.png)
